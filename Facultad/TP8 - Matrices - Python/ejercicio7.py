...
def suma_diagonal_principal(matriz : list, filas : int, columnas : int):
    """Retorna la suma de los elementos que estan por encima de la diagonal principal de una `matriz`"""
    sumatoria = 0
    for fila in range(0, filas):
        for columna in range(0, columnas):
            if (columna > fila):
...
if __name__=="__main__":
    ...
    print(f"La suma de los elementos que estan por encima de la diagonal principal es: {resultado}.")
